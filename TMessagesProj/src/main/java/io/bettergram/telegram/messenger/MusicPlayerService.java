...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "io.bettergram.telegram.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "io.bettergram.telegram.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "io.bettergram.telegram.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "io.bettergram.telegram.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "io.bettergram.telegram.android.musicplayer.next";
